const CafeteriaCard = ({ cafeteria, image }) => {
  return (
    <div className="grid grid-cols-3 mb-2 w-5/6 justify-center items-center rounded bg-gray-100 shadow-md hover:border border-orange-200 ease-in-out duration-300 rounded-2xl">
